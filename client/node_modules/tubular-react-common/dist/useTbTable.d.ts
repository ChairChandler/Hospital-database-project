...
export declare const useTbTable: (initColumns: ColumnModel[], source: string | Request | TubularHttpClientAbstract | {}[], tubularOptions?: Partial<ITbOptions>) => ITbTableInstance;
