...
export declare const useTbList: (initColumns: ColumnModel[], source: string | Request | TubularHttpClientAbstract | {}[], tubularOptions?: Partial<ITbOptions>) => ITbListInstance;
