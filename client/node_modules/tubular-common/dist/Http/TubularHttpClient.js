...
var TubularHttpClient = /** @class */ (function () {
    ...
    TubularHttpClient.prototype.fetch = function (gridRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var response, responseBody, responseObject_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        responseObject_1 = responseBody ? JSON.parse(responseBody) : {};
                        responseKeys.forEach(function (k) {
                            if (responseObject_1.hasOwnProperty(k)) {
                                responseObject_1[k.charAt(0).toLowerCase() + k.slice(1)] = responseObject_1[k];
                                delete responseObject_1[k];
                            }
                        });
                        return [2 /*return*/, responseObject_1];
